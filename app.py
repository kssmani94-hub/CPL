...
def create_tables():
    ...
    if not hasattr(app, 'tables_created'):
        with app.app_context():
            ...
            if not inspector.has_table("user"): # Check if tables exist
                db.create_all()
                ...
                # --- Seed Players (Corrected Indentation) ---
                # This 'if' is temporarily commented out for forcing seeding on Render
                # if Player.query.count() == 0:
                print("Attempting to seed players...") # Indented correctly under 'with'
                players_to_seed = [ # Indented correctly under 'with'
                    Player( # Indented correctly under 'players_to_seed' list
                        player_name="Vasanth Ab", image_filename="vasanth_ab.png",
                        cpl_2024_team="Crazy-11", cpl_2024_innings=8, cpl_2024_runs=302, cpl_2024_average=50.33, cpl_2024_sr=107.86, cpl_2024_hs=75,
                        overall_matches=135, overall_runs=2813, overall_wickets=38, overall_bat_avg=25.81, overall_bowl_avg=21.61
                    ),
                    Player(
                        player_name="Mukil Hitman", image_filename="mukil_hitman.jpg",
                        cpl_2024_team="Thunder Strikers", cpl_2024_innings=9, cpl_2024_runs=268, cpl_2024_average=29.78, cpl_2024_sr=120.18, cpl_2024_hs=46,
                        overall_matches=263, overall_runs=7278, overall_wickets=99, overall_bat_avg=31.51, overall_bowl_avg=20.73
                    ),
                    Player(
                         player_name="M Govindaraj", image_filename="govindaraj.png",
                         cpl_2024_team="Puthiya Sirakukal", cpl_2024_innings=6, cpl_2024_runs=223, cpl_2024_average=44.60, cpl_2024_sr=153.79, cpl_2024_hs=95,
                         overall_matches=83, overall_runs=2098, overall_wickets=56, overall_bat_avg=29.14, overall_bowl_avg=15.32
                    ),
                    Player(
                         player_name="Nithesh Kumar", image_filename="nithesh_kumar.png",
                         cpl_2024_team="APJ Tamizhan Youngstars", cpl_2024_innings=8, cpl_2024_runs=194, cpl_2024_average=24.25, cpl_2024_sr=125.16, cpl_2024_hs=87,
                         overall_matches=220, overall_runs=3485, overall_wickets=77, overall_bat_avg=21.65, overall_bowl_avg=26.03
                    ),
                    Player(
                         player_name="Poovarasan", image_filename="poovarasan.png",
                         cpl_2024_team="SPARTAN ROCKERZ", cpl_2024_innings=6, cpl_2024_runs=186, cpl_2024_average=31.00, cpl_2024_sr=137.78, cpl_2024_hs=63,
                         overall_matches=237, overall_runs=5776, overall_wickets=157, overall_bat_avg=29.03, overall_bowl_avg=19.72
                    ),
                    Player(
                         player_name="R Raja", image_filename="r_raja.png",
                         cpl_2024_team="APJ Tamizhan Youngstars", cpl_2024_innings=8, cpl_2024_runs=171, cpl_2024_average=21.38, cpl_2024_sr=133.59, cpl_2024_hs=61,
                         overall_matches=118, overall_runs=1971, overall_wickets=49, overall_bat_avg=18.95, overall_bowl_avg=13.31
                    ),
                    Player(
                         player_name="Silambu R", image_filename="silambu_r.png",
                         cpl_2024_team="APJ Tamizhan Youngstars", cpl_2024_innings=8, cpl_2024_runs=147, cpl_2024_average=24.50, cpl_2024_sr=125.64, cpl_2024_hs=46,
                         overall_matches=109, overall_runs=1908, overall_wickets=147, overall_bat_avg=23.27, overall_bowl_avg=12.35
                    ),
                    Player(
                         player_name="Prabha", image_filename="prabha.png",
                         cpl_2024_team="Jolly Players", cpl_2024_innings=6, cpl_2024_runs=136, cpl_2024_average=45.33, cpl_2024_sr=107.09, cpl_2024_hs=29,
                         overall_matches=279, overall_runs=6883, overall_wickets=195, overall_bat_avg=35.48, overall_bowl_avg=13.39
                    ),
                    Player(
                         player_name="Hariharan R", image_filename="hariharan_r.png",
                         cpl_2024_team="Thunder Strikers", cpl_2024_innings=9, cpl_2024_runs=130, cpl_2024_average=14.44, cpl_2024_sr=83.33, cpl_2024_hs=34,
                         overall_matches=142, overall_runs=1984, overall_wickets=81, overall_bat_avg=17.71, overall_bowl_avg=18.36
                    ),
                    Player(
                         player_name="Ramesh G", image_filename=None, # Will use default
                         cpl_2024_team="APJ Tamizhan Youngstars", cpl_2024_innings=8, cpl_2024_runs=126, cpl_2024_average=18.00, cpl_2024_sr=104.13, cpl_2024_hs=39,
                         overall_matches=87, overall_runs=1156, overall_wickets=46, overall_bat_avg=18.35, overall_bowl_avg=20.78
                    ),
                ]
                existing_player_names = {p.player_name for p in Player.query.all()} # Indented correctly
                new_players = [p for p in players_to_seed if p.player_name not in existing_player_names] # Indented correctly

                if new_players: # Indented correctly
                    db.session.bulk_save_objects(new_players) # Indented correctly
                    db.session.commit()                       # Indented correctly
                    print(f"{len(new_players)} new players seeded.") # Indented correctly
                else:                                         # Indented correctly
                     print("All players already seem to exist.")# Indented correctly
                # REMEMBER TO UNCOMMENT THE 'if Player.query.count() == 0:' LATER
