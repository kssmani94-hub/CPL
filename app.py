...
@app.before_request
def create_tables():
    # Only create tables if using SQLite and the file doesn't exist
...
# --- Seed Players ---
            if Player.query.count() == 0:
                players = [
                    Player(
                        player_name="Vasanth Ab",
                        image_filename="vasanth_ab.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Mukil Hitman",
                        image_filename="mukil_hitman.jpg", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="M Govindaraj",
                        image_filename="govindaraj.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Nithesh Kumar",
                        image_filename="nithesh_kumar.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Poovarasan",
                        image_filename="poovarasan.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="R Raja",
                        image_filename="r_raja.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Silambu R",
                        image_filename="silambu_r.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Prabha",
                        image_filename="prabha.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Hariharan R",
                        image_filename="hariharan_r.png", # <-- ADD FILENAME HERE
                    ...
                    Player(
                        player_name="Ramesh G",
                        # No image_filename provided, will use default_player.png
